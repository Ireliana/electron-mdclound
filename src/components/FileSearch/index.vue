    ...
    <div id="file-search">
        <el-row>
            <el-col class="title" :span="14">
                <el-input v-if="isSearch" ref="file-input" size="small" v-model="filename" placeholder="请输入文件名"></el-input>
                <p v-else>
                    {{title}}
                </p>
            </el-col>
            <el-col :span="6">
                <el-button @click="onSearch" type="small" :icon="iconName">{{btnText}}</el-button>
            </el-col>
        </el-row>
    </div>
</template>
